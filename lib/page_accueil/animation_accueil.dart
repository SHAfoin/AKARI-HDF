      ...
      builder: (context, box, _) {
        ...
        if (widget.side == Side.bottom) {
          cases = {
            ...
            10: Case.blancheRemplie(60, Bulb.getAmpoule(bulb).ampoule),
            13: Case.noirRemplie(45, 2),
            16: Case.noirVide(35),
            21: Case.blancheRemplie(40, Bulb.getAmpoule(bulb).ampoule),
          ...
          cases = {
            ...
            12: Case.noirVide(55),
            14: Case.blancheRemplie(45, Bulb.getAmpoule(bulb).ampoule),
          ...
          itemBuilder: (context, index) {
            if (cases.containsKey(index)) {
              ...
              return RotationTransition(
                turns: turnsTween
                    .chain(CurveTween(
                        curve: Curves.easeOutSine)) // Curve de vitesse
                    .animate(controller),
                child: Transform.rotate(
                  angle: (-pi / 18) * (index % 7) +
                      (pi / 6), // angle de départ de la case
                  child: Center(
                    child: Container(
